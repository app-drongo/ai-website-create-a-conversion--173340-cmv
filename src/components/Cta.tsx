// Cta Component
// Generated: 2025-09-07T14:26:13.270Z
// Template: cta-c001
// Context: Homepage
...
export default function Cta() {
  const stats = [
    { value: "300%", label: "ROI Increase", icon: Zap },
    { value: "99.9%", label: "Uptime SLA", icon: Shield },
    { value: "15K+", label: "Tech Professionals", icon: Users },
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join tech leaders who've increased their conversion rates by 300% with ConvertNow's 
                AI-powered optimization platform. Deploy in minutes, see results instantly.
              </p>
              ...
              <div className="text-center mb-12">
                <p className="text-sm text-muted-foreground mb-6">
                  Trusted by leading tech companies and startups
                </p>
        ...
        <div className="text-center mt-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <h3 className="font-semibold">Free Beta Access</h3>
